...
To update aconfig protos, run
`protoc --plugin=vendor/adevtool/node_modules/.bin/protoc-gen-ts_proto --ts_proto_out vendor/adevtool/src/proto-ts build/make/tools/aconfig/aconfig_protos/protos/aconfig.proto`
